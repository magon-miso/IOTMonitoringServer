...
const char ssid[] = "SOLANOMENDI"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Cesitarsolano2004"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "35.173.198.60"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
